## v1.0.0 (2026-01-10 22:04:19)
**Release v1.0.0**

- **Feature**: `gTTS.py` — wrapper that pipes `gtts-cli` output to `ffplay` for immediate playback.
- **Docs**: `README.md` updated with `venv/` setup (Windows, Linux, macOS), `Kardenwort` section, and Return-to-Top links for easier navigation.
